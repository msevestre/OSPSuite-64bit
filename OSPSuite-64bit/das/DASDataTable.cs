...
namespace OSPSuite_64bit.das
{
   internal class ParameterValue
   {
      ...
      /// <summary>
      /// This property is the <see cref="OSPSuite_64bit.das.DAS.ServerTypes"></see> of the parameter.
      /// </summary>
      /// <returns>Value of <see cref="OSPSuite_64bit.das.DAS.ServerTypes"></see>.</returns>
      public DAS.ServerTypes ServerType { get; set; }

      /// <summary>
      /// This property is the mode of the parameter.
      /// </summary>
      /// <returns>Value of <see cref="OSPSuite_64bit.das.DAS.ParameterModes"></see>.</returns>
   ...
   public class DASDataTable : DataTable, IEnumerable
   {
      ...
      private readonly OSPSuite_64bit.das.DAS m_DAS;
