...
namespace OSPSuite.TeXReporting.TeX
{
   ...
   {
      private const string MIK_TEX_REGISTRY_PATH = @"HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Open Systems Pharmacology\MikTex";
...
//            var path = "C:\\Open Systems Pharmacology\\MikTex 2.9.3\\";
